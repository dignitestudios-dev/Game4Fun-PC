...
function ProfileBanner() {
  return (
     <div className="relative z-20">
      <div className="absolute bg-[url(/images/shop-bg.png)] -top-28 left-0 bg-no-repeat bg-contain w-screen h-[300px]" />
      ...
      <div className="flex flex-col gap-3 justify-center items-center h-[200px] relative z-20">
        <div className="relative">
          <StyledHeader title="My profile" backTitle="My profile" classname="right-[-450%]" />
        </div>
