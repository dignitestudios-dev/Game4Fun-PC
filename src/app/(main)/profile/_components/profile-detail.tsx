    ...
    <div className="bg-[#2A2929CC] p-5 px-10 rounded-3xl mb-20 w-[90%] mx-auto">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          <Image
            src={userData ? userData?.profilePicture as string : "/images/man.png"}
            alt="man"
            width={150}
            height={150}
      ...
      {open && (
          ...
          <div className="bg-[#2A2929] flex flex-col gap-4 items-center rounded-xl p-6 w-[90%] max-w-md text-white shadow-lg">
        <div
